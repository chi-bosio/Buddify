...
<>
<section
className="bg-[url('/assets/fondoLanding.png')] bg-cover bg-center text-customPalette-white py-20 text-center"
>
<div className="bg-black bg-opacity-50 py-20">
  <div className="container mx-auto px-4">
    ...
    <p className="mt-4 text-sm text-customPalette-gray">
      ¿Ya tienes tu cuenta? 
      <Link href="/login" className="text-customPalette-orange hover:underline">
         Login
      </Link>
  </p>
  </div>
