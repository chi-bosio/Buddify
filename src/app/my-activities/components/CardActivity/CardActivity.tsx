...
export function CardActivity({
  ...
  return (
    <div
      className={` flex flex-col items-start justify-end w-full rounded h-48 bg-customPalette-white shadow-lg border border-customPalette-gray py-2 px-2`}
    >
      <div className="relative h-full w-full rounded overflow-hidden">
        ...
        <div className="z-20 absolute bottom-0 left-0 flex justify-between items-center w-full bg-customPalette-whitelight px-2 py-2">
          <h4 className="font-semibold text-base text-customPalette-blue ">
            {activity.name}
          </h4>
          <div className="flex justify-between items-center">
            <Eye
              className="h-6 w-6 mr-4 text-customPalette-blue hover:text-customPalette-bluelight cursor-pointer"
              onClick={handlerOnView}
            ></Eye>
            <Trash2
              className="h-6 w-6 text-customPalette-red hover:text-customPalette-redlight cursor-pointer "
