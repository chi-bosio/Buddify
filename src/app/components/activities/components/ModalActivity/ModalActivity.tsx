          ...
          <div className="w-full h-full flex items-start justify-start flex-col">
            ...
            <div className="h-full w-full flex items-end justify-end">
              <button
                ...
                className="text-xs bg-customPalette-blue text-white px-4 py-2 rounded-md shadow-md hover:bg-customPalette-bluelight duration-300 ease-in-out mr-3"
              >
                Ver en el calendario
              </button>
              <button
                onClick={() => handlerSubmit(id, userId, onClose, text)}
                className="text-xs bg-customPalette-orange text-white px-4 py-2 rounded-md shadow-md hover:bg-customPalette-orangebright duration-300 ease-in-out"
              >
                {textSubmit}
              </button>
              <button
                onClick={handleReportClick}
                className="text-xs bg-red-500 text-white px-3 py-1 rounded-md shadow-md hover:bg-red-600 duration-300 ease-in-out"
              >
                Reportar Actividad
              </button>
            </div>
